...
- (void)viewDidLoad {
    ...
    self.filterView.frame = CGRectMake(self.filterView.frame.origin.x, self.filterView.frame.origin.y, self.filterView.frame.size.width, self.filterView.frame.size.height/2);
...
-(void)initalizeArrays{
    self.youngest = [NSArray arrayWithObjects:@"15",@"20",@"25",@"30",@"35",@"40",@"45",@"50",@"55",@"60",nil];
    self.oldest = [NSArray arrayWithObjects:@"20",@"25",@"30",@"35",@"40",@"45",@"50",@"55",@"60",@"65",nil];
